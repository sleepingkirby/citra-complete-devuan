...
template<typename V>
std::experimental::optional<std::reference_wrapper<const Thumb16Matcher<V>>> DecodeThumb16(u16 instruction) {
...
#undef INST
    ...
    return iter != table.end() ? std::experimental::optional<std::reference_wrapper<const Thumb16Matcher<V>>>(*iter) : std::experimental::nullopt;
}
